  ...
  return (
    <footer className="main-footer">
      <div className="container footer-grid">
        <div className="footer-brand">
          <a href="#" className="logo">
            <img src="/logo.png" alt="Mayuresh Photography Logo" className="footer-logo-img" style={{ height: '24px', width: 'auto' }} />
          ...
          <a
            href="https://wa.me/919876543210?text=Hi%2C%20I%20would%20like%20to%20book%20a%20photography%20session%20at%20Mayuresh%20Photography."
            target="_blank"
      ...
      <div className="footer-bottom text-center">
        <p>&copy; 2026 Mayuresh Photography. All Rights Reserved. Built with Visual Excellence.</p>
      </div>
    </footer>
  );
}
